...
classdef Vehicle < handle
    ...
    methods
        ...
        % 'verbose'       Be verbose
        % 'V_IMU'         Noise on IMU measurements 
        %
        % Notes::
        ...
        function theta_IMU = get_IMU(veh)
        %Return IMU angle
            
            theta_IMU = veh.theta_IMU;
        ...
        function odo = step(veh, varargin)
            ...
            veh.theta_IMU = veh.theta_IMU + odo(2) + randn(1,1)*sqrt(veh.V_IMU);
